...
int InicializaSistema (TipoSistema *p_sistema) {
	...
	//Inicializamos el efecto del sistema
	InicializaEfecto(&(p_sistema->player.efecto_disparo),p_sistema->player.efecto_disparo.nombre,frecuenciaDespacito,tiempoDespacito,160);
...
int main ()
{
	...
	fsm_t* player_fsm = fsm_new (WAIT_START, reproductor, &(sistema.player)); //Hemos a�adido el timer
